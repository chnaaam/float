...
class InferenceOptions(BaseOptions):
	...
	def initialize(self, parser):
		...
		parser.add_argument("--ref_path",
				default="ref_image.jpeg", type=str,help='ref')
		parser.add_argument('--aud_path',
				default="voice-only.wav", type=str, help='audio')
		parser.add_argument('--emo',
				default="surprise", type=str, help='emotion', choices=['angry', 'disgust', 'fear', 'happy', 'neutral', 'sad', 'surprise'])
		...
		parser.add_argument('--ckpt_path',
				default="/root/float/checkpoints/float.pth", type=str, help='checkpoint path')
